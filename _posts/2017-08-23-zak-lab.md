...
location: Boston, MA
categories: Research
excerpt: Estimation of the predictive value of genetic screening across six cardiac conditions
image: /img/zaklab-exac-long.png
featured: true
---
...
<img src="/img/penetrance_boxplot.png" alt="Penetrance Boxplot" title="Penetrance Boxplot" class="img-responsive" style="width:600px;height:auto;">  
...
We've also encapsulated our analysis in a web tool that allows users to substitute their own estimates of population parameters and reproduce key figures. 
...
<img src="/img/zaklab_frac.png" alt="Fraction Plot" title="Fraction Plot" class="img-responsive" style="width:600px;height:auto;">  

### 2.3 Example Time-Series Plots
<img src="/img/zaklab_submissions.png" alt="Submissions Plot" title="Submissions Plot" class="img-responsive" style="width:510px;height:auto;"> 

<img src="/img/zaklab_significances.png" alt="Significances Plot" title="Significances Plot" class="img-responsive" style="width:550px;height:auto;"> 
